...
plotGO <- function(go, xlab = "Biological Process", ylab = "-log10(p-value)", n = 10) {
    go$new_term <- go$Term
    ...
    ggplot(go, aes(x = new_term, y = -log10(P.DE))) +
        ...
        theme(
            ...
            axis.text.x = element_text(angle = 0, size = 9, hjust = 1.10),
...
ggsave(plotGO(bp, xlab = "Biological Process"), file = "GO_Cells_BP.pdf")
print("## MF")
mf <- topGO(allRes, ontology = "MF", number = num)
rmarkdown::paged_table(mf)
ggsave(plotGO(mf, xlab = "Molecular Function"), file = "GO_Cells_MF.pdf")
print("## CC")
cc <- topGO(allRes, ontology = "CC", number = num)
rmarkdown::paged_table(cc)
ggsave(plotGO(cc, xlab = "Cellular Component"), file = "GO_Cells_CC.pdf")
```
...
```{r cells_phyc_paramterers, echo = TRUE, eval=TRUE}
t <- tT[, "t"]
...
```{r violin_phyco_cells, eval = TRUE}
## gravy
...
```{r ff_1_phyco, echo = TRUE, eval = TRUE}
t <- tT[, "t"]
...
bp <- topGO(allRes, ontology = "BP", number = num)
rmarkdown::paged_table(bp)
ggsave(plotGO(bp, xlab = "Biological Process"), file = "GO_FF_BP.pdf")
print("## MF")
mf <- topGO(allRes, ontology = "MF", number = num)
rmarkdown::paged_table(mf)
ggsave(plotGO(mf, xlab = "Molecular Function"), file = "GO_FF_MF.pdf")
print("## CC")
cc <- topGO(allRes, ontology = "CC", number = num)
rmarkdown::paged_table(cc)
ggsave(plotGO(cc, xlab = "Cellular Component"), file = "GO_FF_CC.pdf")
```
...
```{r ff_phyco_parameters, echo = TRUE, eval = TRUE}
t <- tT[, "t"]
...
```{r ffpe_1_phyco, echo = TRUE, eval=TRUE}
t <- tT[, "t"]
...
allRes <- enrichment(tT, organism = "Hs")
print("## BP")
bp <- topGO(allRes, ontology = "BP", 
    number = nrow(allRes[allRes[, "Ont"] == "BP", ]))
rmarkdown::paged_table(bp)
ggsave(plotGO(bp, xlab = "Biological Process"), file = "GO_FFPE_BP.pdf")
print("## MF")
mf <- topGO(allRes, ontology = "MF", 
    number = nrow(allRes[allRes[, "Ont"] == "MF", ]))
rmarkdown::paged_table(mf)
ggsave(plotGO(mf, xlab = "Molecular Function"), file = "GO_FFPE_MF.pdf")
print("## CC")
cc <- topGO(allRes, ontology = "CC", 
    number = nrow(allRes[allRes[, "Ont"] == "CC", ]))
rmarkdown::paged_table(cc)
ggsave(plotGO(cc, xlab = "Cellular Component"), file = "GO_FFPE_CC.pdf")
```
...
```{r ffpe_2_phyco, echo = TRUE, eval=TRUE}
t <- tT[, "t"]
...
bp <- topGO(allRes, ontology = "BP", number = num)
rmarkdown::paged_table(bp)
ggsave(plotGO(bp, xlab = "Biological Process"), file = "GO_Plasma_BP.pdf")
print("## MF")
mf <- topGO(allRes, ontology = "MF", number = num)
rmarkdown::paged_table(mf)
ggsave(plotGO(mf, xlab = "Molecular Function"), file = "GO_Plasma_MF.pdf")
print("## CC")
cc <- topGO(allRes, ontology = "CC", number = num)
rmarkdown::paged_table(cc)
ggsave(plotGO(cc, xlab = "Cellular Component"), file = "GO_Plasma_CC.pdf")
```
...
```{r plasma_phyco, echo = TRUE, eval=TRUE}
t <- tT[, "t"]
...
bp <- topGO(allRes, ontology = "BP", number = num)
rmarkdown::paged_table(bp)
ggsave(plotGO(bp, xlab = "Biological Process"), file = "GO_Serum_BP.pdf")
print("## MF")
mf <- topGO(allRes, ontology = "MF", number = num)
rmarkdown::paged_table(mf)
ggsave(plotGO(mf, xlab = "Molecular Function"), file = "GO_Serum_MF.pdf")
print("## CC")
cc <- topGO(allRes, ontology = "CC", number = num)
rmarkdown::paged_table(cc)
ggsave(plotGO(cc, xlab = "Cellular Component"), file = "GO_Serum_CC.pdf")
```
...
```{r serum_phyco, echo = TRUE, eval=TRUE}
t <- tT[, "t"]
