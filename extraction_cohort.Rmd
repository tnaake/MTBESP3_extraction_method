...
## keep features with more than ca. 91% (32/35) measured values
se <- se[rowSums(is.na(assay(se))) < 4 , ]
...
write.table(tT, file = "proteomics_DE_t_TUvsNG_MTBE_SP3.txt", 
    quote = FALSE, sep = "\t")
...
cor.test(tT_autoSP3$t[order(rownames(tT_autoSP3))],
    tT_MTBE_SP3$t[order(rownames(tT_MTBE_SP3))], method = "spearman")
